...
public class Product_Pojo {
	...
	public Product_Pojo(String pname, String pdesc, int pquantity, int pactualprice, int pprice, int pdiscount,
	...
	public String toString() {
		return "Product_Pojo [id=" + id + ", pname=" + pname + ", pdesc=" + pdesc + ", pquantity=" + pquantity
